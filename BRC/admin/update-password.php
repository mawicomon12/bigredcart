<?php include('partials/menu.php'); ?>
    ...
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($res==true)
            {
                //chechk whether the data is available or not +
                ...
                if($count==1)
                {
                    ...
                    if($new_password==$confirm_password)
                    {
                        ...
                        {
                            //redirect to manage admin page with error message
                            $_SESSION['change-pwd'] = "<div class='error'>Password change unsuccessfully. </div>";
                ...
                {
                    //user does not exist set messageand redirect
